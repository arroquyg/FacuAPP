...
export default function HistorialMovimientos({
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-lg font-semibold text-gray-700">Historial de movimientos</h2>
            ...
            <tbody className="divide-y divide-gray-100">
              {filtrados.map((m) => (
                <tr key={m.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 font-mono text-gray-700">{m.chip_id}</td>
                  <td className="px-4 py-3 text-gray-600">{m.origen}</td>
      ...
      <p className="text-xs text-gray-400">{filtrados.length} de {movimientos.length} movimientos</p>
    </div>
  );
}
